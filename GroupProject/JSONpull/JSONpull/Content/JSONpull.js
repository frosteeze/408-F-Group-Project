...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,console,JSONpull,Client;
 Runtime.Define(Global,{
  JSONpull:{
   Client:{
 ...
 {
  console=Runtime.Safe(Global.console);
  JSONpull=Runtime.Safe(Global.JSONpull);
  return Client=Runtime.Safe(JSONpull.Client);
 });
 Runtime.OnLoad(function()
 {
  Client.Main();
